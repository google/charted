...
if(C.tQ.x4(y))this.a=C.tQ.p(0,y)
else this.Q=a},
...
z=new Q.S(!1,null,[1,1],0,0.5*(1+Math.sqrt(5)),new Q.W(),Q.oQ(),Q.M(),Q.Z())
z.f=b
y=this.a
x=this.b
z.e=[y,x]
...
t.bv(0,"width",""+y+"px")
t.bv(0,"height",""+x+"px")
x=S.E2(null,null,".node",t).uD(S.T9(w),null).c.Y(0,"div")
x.vB("left",new K.VY())
x.vB("top",new K.RH())
x.vB("width",new K.Jn())
...
z=J.R(a)
if(J.pO(z.gwd(a))){z=z.gph(a)
y=this.Q.Q
x=y.Q
if(!x.x4(z)){w=y.a
x.q(0,z,w.length)
w.push(z)}w=y.b
v=w.length!==0?w[C.CD.V(x.p(0,z),y.b.length)]:0
z=J.t(v)
z=!!z.$iszM&&v.length>1?z.Zv(v,1):v}else z=null
return z}},
uG:{
"^":"r;",
$3:function(a,b,c){var z=J.R(a)
...
eC:{
"^":"a;",
eI:["CD",function(a,b,c,d){var z,y,x,w,v,u,t,s,r,q,p,o
z=[]
for(y=new H.a7(a,15,0,null);y.D();){x=y.c
w=J.U6(x)
...
t.Q=s
t.d=s.d+1
for(y=t.a,y=new H.a7(y,y.length,0,null);y.D();){r=y.c
r.d=r.gyt()+1}}q=[]
...
x=b>0?C.ON.zQ(e/b):0
w=c.f
if(b===w){if(d||x>c.r)x=c.r
for(v=new H.a7(a,a.length,0,null),u=x>0;v.D();){t=v.c
s=J.R(t)
s.sx(t,z)
s.sy(t,y)
s.sqV(t,x)
...
q=P.C(s+r-z,q)
t.r=q
z+=q}C.Nm.grZ(a).sOb(!0)
v=C.Nm.grZ(a)
u=J.R(v)
u.sZ(v,u.gZ(v)+(c.d+c.f-z))
c.e+=x
c.r-=x}else{if(d||x>w)x=w
for(v=new H.a7(a,a.length,0,null),u=x>0;v.D();){t=v.c
s=J.R(t)
s.sx(t,z)
s.sy(t,y)
...
q=P.C(s+r-y,q)
t.x=q
y+=q}C.Nm.grZ(a).sOb(!1)
v=C.Nm.grZ(a)
u=J.R(v)
u.sqV(v,u.gqV(v)+(c.e+c.r-y))
c.d+=x
c.f-=x}},
pc:function(a,b){var z,y,x,w,v
for(z=new H.a7(a,a.length,0,null),y=b<0;z.D();){x=z.c
w=J.SW(x)
v=J.lX(w,y?0:b)
x.sY7(v<=0?0:v)}},
YF:function(a,b,c){var z,y,x,w
for(z=new H.a7(a,a.length,0,null),y=0,x=1/0;z.D();){w=z.c.gY7()
if(w<=0)continue
if(w<x)x=w
if(w>y)y=w}c*=c
b*=b
...
if(u<0){w+=u/2
u=0}if(t<0){v+=t/2
t=0}s=new Z.wP(w,v,u,t,0,0,0,0)
r=[]
q=P.z(z,!0,null)
y=this.f
if(y===1)p=u
...
o+=l.gY7()
k=this.YF(r,p,o)
if(this.f!==0||k<=n){q.pop()
n=k}else{this.h5(r,p,s,!1,o-r.pop().gY7())
p=P.C(s.f,s.r)
C.Nm.sv(r,0)
o=0
n=1/0}}if(r.length!==0){this.h5(r,p,s,!0,o)
...
y.Rn(b,c,d,z)
return y},T:function(a,b){var z=new S.SM(null,b,null)
z.yV(a,b)
return z}}},
NJ:{
"^":"r;Q,a",
...
u=x.Q[w]
t=[]
for(s=v.Q,r=J.U6(s),q=r.gv(s),p=J.R(u),o=0;o<q;++o){n=r.Zv(s,o)
if(n!=null){m=this.a
m.toString
m=m.Q
...
J.C7(p.gP9(u),o,j)
t.push(j)}else t.push(null)}z.push(new S.zm(t,v.a))}return new S.SM(z,this.a,null)}},
xL:{
"^":"r;Q",
$3:function(a,b,c){return Z.JN(this.Q,c)}},
K8:{
...
$isa:1,
"%":"CDATASection|CharacterData|Comment|DocumentType|Notation|ProcessingInstruction|Text;Node"},
BH:{
"^":"w1;",
gv:function(a){return a.length},
p:function(a,b){if(b>>>0!==b||b>=a.length)throw H.b(P.Cf(b,a,null,null,null))
...
init.metadata=[{func:"Th",void:true,args:[Q.Gn]},{func:"Ax",ret:P.zM,args:[Q.xT]},{func:"ML",ret:P.lf,args:[Q.xT]},{func:"qr",ret:P.P,args:[Q.xT,Q.xT]},{func:"Gl",ret:P.a2,args:[null,null]},{func:"bX",ret:P.P,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.P,args:[P.a]},];$=null
...
if(typeof dartMainRunner==="function"){dartMainRunner(K.QL,[])}else{K.QL([])}})
})()
