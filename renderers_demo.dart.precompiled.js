...
if($desc instanceof Array)$desc=$desc[1]
Zz.prototype=$desc
Zz.prototype.gy0=function(receiver){return receiver.hostname}
Zz.prototype.smH=function(receiver,v){return receiver.href=v}
Zz.prototype.gtp=function(receiver){return receiver.port}
Zz.prototype.gA8=function(receiver){return receiver.protocol}
...
Um.prototype.gt5=function(receiver){return receiver.type}
...
bv.prototype.gR=function(receiver){return receiver.width}
bv.prototype.gx=function(receiver){return receiver.x}
bv.prototype.gy=function(receiver){return receiver.y}
...
if($desc instanceof Array)$desc=$desc[1]
XR.prototype=$desc
function LI(vI,yl,Jt,TX,Y2,Ok){this.vI=vI
this.yl=yl
this.Jt=Jt
this.TX=TX
this.Y2=Y2
...
if($desc instanceof Array)$desc=$desc[1]
LI.prototype=$desc
function IN(MU,Rn,XZ,Rv,hG,Mo,AM,NE){this.MU=MU
this.Rn=Rn
this.XZ=XZ
this.Rv=Rv
this.hG=hG
...
if($desc instanceof Array)$desc=$desc[1]
u8.prototype=$desc
function Zr(zj,TX,v7,Wb,Xr,UP){this.zj=zj
this.TX=TX
this.v7=v7
this.Wb=Wb
this.Xr=Xr
...
if($desc instanceof Array)$desc=$desc[1]
Zo.prototype=$desc
function u0(kv,Xr,UP){this.kv=kv
this.Xr=Xr
this.UP=UP}u0.builtin$cls="u0"
...
function MV(xy,ph,t5,B1){this.xy=xy
this.ph=ph
this.t5=t5
...
MV.prototype.gt5=function(receiver){return this.t5}
...
if($desc instanceof Array)$desc=$desc[1]
Zw.prototype=$desc
function Gp(RB,Y7,Ax,dL,Ay,Jf,YK,Jd,Co,lD,rr){this.RB=RB
this.Y7=Y7
this.Ax=Ax
this.dL=dL
this.Ay=Ay
...
this.Co=Co
this.lD=lD
this.rr=rr}Gp.builtin$cls="Gp"
if(!"name" in Gp)Gp.name="Gp"
$desc=$collectedClasses.Gp
if($desc instanceof Array)$desc=$desc[1]
Gp.prototype=$desc
Gp.prototype.gRB=function(){return this.RB}
...
if($desc instanceof Array)$desc=$desc[1]
zx.prototype=$desc
function HV(f,UI){this.f=f
this.UI=UI}HV.builtin$cls="HV"
...
if($desc instanceof Array)$desc=$desc[1]
mQ.prototype=$desc
function M0(bK){this.bK=bK}M0.builtin$cls="M0"
if(!"name" in M0)M0.name="M0"
$desc=$collectedClasses.M0
if($desc instanceof Array)$desc=$desc[1]
M0.prototype=$desc
function vb(Gq){this.Gq=Gq}vb.builtin$cls="vb"
if(!"name" in vb)vb.name="vb"
$desc=$collectedClasses.vb
if($desc instanceof Array)$desc=$desc[1]
vb.prototype=$desc
function XIf(Rm,w3){this.Rm=Rm
this.w3=w3}XIf.builtin$cls="XIf"
if(!"name" in XIf)XIf.name="XIf"
$desc=$collectedClasses.XIf
if($desc instanceof Array)$desc=$desc[1]
XIf.prototype=$desc
function vOj(HZ){this.HZ=HZ}vOj.builtin$cls="vOj"
if(!"name" in vOj)vOj.name="vOj"
$desc=$collectedClasses.vOj
if($desc instanceof Array)$desc=$desc[1]
vOj.prototype=$desc
function zxb(mG){this.mG=mG}zxb.builtin$cls="zxb"
if(!"name" in zxb)zxb.name="zxb"
$desc=$collectedClasses.zxb
if($desc instanceof Array)$desc=$desc[1]
zxb.prototype=$desc
function HVA(xC){this.xC=xC}HVA.builtin$cls="HVA"
if(!"name" in HVA)HVA.name="HVA"
$desc=$collectedClasses.HVA
if($desc instanceof Array)$desc=$desc[1]
HVA.prototype=$desc
function mQm(cj,jk){this.cj=cj
this.jk=jk}mQm.builtin$cls="mQm"
if(!"name" in mQm)mQm.name="mQm"
$desc=$collectedClasses.mQm
if($desc instanceof Array)$desc=$desc[1]
mQm.prototype=$desc
function j72(i0){this.i0=i0}j72.builtin$cls="j72"
if(!"name" in j72)j72.name="j72"
$desc=$collectedClasses.j72
if($desc instanceof Array)$desc=$desc[1]
j72.prototype=$desc
function M0h(r){this.r=r}M0h.builtin$cls="M0h"
if(!"name" in M0h)M0h.name="M0h"
$desc=$collectedClasses.M0h
if($desc instanceof Array)$desc=$desc[1]
M0h.prototype=$desc
function Bhb(YC,Pz){this.YC=YC
this.Pz=Pz}Bhb.builtin$cls="Bhb"
if(!"name" in Bhb)Bhb.name="Bhb"
$desc=$collectedClasses.Bhb
if($desc instanceof Array)$desc=$desc[1]
Bhb.prototype=$desc
function Wja(a,Of,Fc){this.a=a
this.Of=Of
this.Fc=Fc}Wja.builtin$cls="Wja"
if(!"name" in Wja)Wja.name="Wja"
$desc=$collectedClasses.Wja
if($desc instanceof Array)$desc=$desc[1]
Wja.prototype=$desc
function vba(ES){this.ES=ES}vba.builtin$cls="vba"
if(!"name" in vba)vba.name="vba"
$desc=$collectedClasses.vba
if($desc instanceof Array)$desc=$desc[1]
vba.prototype=$desc
function X1(x){this.x=x}X1.builtin$cls="X1"
...
if($desc instanceof Array)$desc=$desc[1]
kQ.prototype=$desc
function o5(RB,Y7,Ax,dL,Ay,Jf,YK,Jd,Co,lD,rr){this.RB=RB
this.Y7=Y7
this.Ax=Ax
this.dL=dL
this.Ay=Ay
...
if($desc instanceof Array)$desc=$desc[1]
fn.prototype=$desc
function LB(Rm){this.Rm=Rm}LB.builtin$cls="LB"
if(!"name" in LB)LB.name="LB"
$desc=$collectedClasses.LB
if($desc instanceof Array)$desc=$desc[1]
LB.prototype=$desc
function Rb(w3){this.w3=w3}Rb.builtin$cls="Rb"
if(!"name" in Rb)Rb.name="Rb"
$desc=$collectedClasses.Rb
if($desc instanceof Array)$desc=$desc[1]
Rb.prototype=$desc
function Ew8(HZ){this.HZ=HZ}Ew8.builtin$cls="Ew8"
if(!"name" in Ew8)Ew8.name="Ew8"
$desc=$collectedClasses.Ew8
if($desc instanceof Array)$desc=$desc[1]
Ew8.prototype=$desc
function PDr(mG){this.mG=mG}PDr.builtin$cls="PDr"
if(!"name" in PDr)PDr.name="PDr"
$desc=$collectedClasses.PDr
if($desc instanceof Array)$desc=$desc[1]
PDr.prototype=$desc
function fnu(xC){this.xC=xC}fnu.builtin$cls="fnu"
if(!"name" in fnu)fnu.name="fnu"
$desc=$collectedClasses.fnu
if($desc instanceof Array)$desc=$desc[1]
fnu.prototype=$desc
function a3c(cj){this.cj=cj}a3c.builtin$cls="a3c"
if(!"name" in a3c)a3c.name="a3c"
$desc=$collectedClasses.a3c
if($desc instanceof Array)$desc=$desc[1]
a3c.prototype=$desc
function Dza(jk){this.jk=jk}Dza.builtin$cls="Dza"
if(!"name" in Dza)Dza.name="Dza"
$desc=$collectedClasses.Dza
if($desc instanceof Array)$desc=$desc[1]
Dza.prototype=$desc
function P4i(b,i0){this.b=b
this.i0=i0}P4i.builtin$cls="P4i"
if(!"name" in P4i)P4i.name="P4i"
$desc=$collectedClasses.P4i
if($desc instanceof Array)$desc=$desc[1]
P4i.prototype=$desc
function fik(){}fik.builtin$cls="fik"
if(!"name" in fik)fik.name="fik"
$desc=$collectedClasses.fik
if($desc instanceof Array)$desc=$desc[1]
fik.prototype=$desc
function LBb(r){this.r=r}LBb.builtin$cls="LBb"
if(!"name" in LBb)LBb.name="LBb"
$desc=$collectedClasses.LBb
if($desc instanceof Array)$desc=$desc[1]
LBb.prototype=$desc
function Qma(YC){this.YC=YC}Qma.builtin$cls="Qma"
if(!"name" in Qma)Qma.name="Qma"
$desc=$collectedClasses.Qma
if($desc instanceof Array)$desc=$desc[1]
Qma.prototype=$desc
function Rba(a,Pz){this.a=a
this.Pz=Pz}Rba.builtin$cls="Rba"
if(!"name" in Rba)Rba.name="Rba"
$desc=$collectedClasses.Rba
if($desc instanceof Array)$desc=$desc[1]
Rba.prototype=$desc
function naa(a,Of){this.a=a
this.Of=Of}naa.builtin$cls="naa"
if(!"name" in naa)naa.name="naa"
$desc=$collectedClasses.naa
if($desc instanceof Array)$desc=$desc[1]
naa.prototype=$desc
function E1(a,Fc){this.a=a
this.Fc=Fc}E1.builtin$cls="E1"
if(!"name" in E1)E1.name="E1"
$desc=$collectedClasses.E1
if($desc instanceof Array)$desc=$desc[1]
E1.prototype=$desc
function E5(a,ES){this.a=a
this.ES=ES}E5.builtin$cls="E5"
if(!"name" in E5)E5.name="E5"
$desc=$collectedClasses.E5
if($desc instanceof Array)$desc=$desc[1]
E5.prototype=$desc
function E6(a,x){this.a=a
this.x=x}E6.builtin$cls="E6"
if(!"name" in E6)E6.name="E6"
$desc=$collectedClasses.E6
if($desc instanceof Array)$desc=$desc[1]
E6.prototype=$desc
function LG(RB,ti,Fn,Hk,u5,NS,Y7,Ax,dL,Ay,Jf,YK,Jd,Co,lD,rr){this.RB=RB
this.ti=ti
this.Fn=Fn
this.Hk=Hk
this.u5=u5
...
function ZX(c){this.c=c}ZX.builtin$cls="ZX"
if(!"name" in ZX)ZX.name="ZX"
$desc=$collectedClasses.ZX
if($desc instanceof Array)$desc=$desc[1]
ZX.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
LH.prototype=$desc
function mO(d){this.d=d}mO.builtin$cls="mO"
if(!"name" in mO)mO.name="mO"
$desc=$collectedClasses.mO
if($desc instanceof Array)$desc=$desc[1]
mO.prototype=$desc
function Fo(e){this.e=e}Fo.builtin$cls="Fo"
if(!"name" in Fo)Fo.name="Fo"
$desc=$collectedClasses.Fo
if($desc instanceof Array)$desc=$desc[1]
Fo.prototype=$desc
function IC(f){this.f=f}IC.builtin$cls="IC"
if(!"name" in IC)IC.name="IC"
$desc=$collectedClasses.IC
if($desc instanceof Array)$desc=$desc[1]
IC.prototype=$desc
function ee(UI,bK){this.UI=UI
this.bK=bK}ee.builtin$cls="ee"
if(!"name" in ee)ee.name="ee"
$desc=$collectedClasses.ee
if($desc instanceof Array)$desc=$desc[1]
ee.prototype=$desc
function ps(Gq){this.Gq=Gq}ps.builtin$cls="ps"
if(!"name" in ps)ps.name="ps"
$desc=$collectedClasses.ps
if($desc instanceof Array)$desc=$desc[1]
ps.prototype=$desc
function wf(Rm){this.Rm=Rm}wf.builtin$cls="wf"
if(!"name" in wf)wf.name="wf"
$desc=$collectedClasses.wf
if($desc instanceof Array)$desc=$desc[1]
wf.prototype=$desc
function Oa(w3,HZ,mG,xC,cj,jk){this.w3=w3
this.HZ=HZ
this.mG=mG
this.xC=xC
this.cj=cj
this.jk=jk}Oa.builtin$cls="Oa"
if(!"name" in Oa)Oa.name="Oa"
$desc=$collectedClasses.Oa
if($desc instanceof Array)$desc=$desc[1]
Oa.prototype=$desc
function Bs(i0,r,YC,Pz,Of,Fc){this.i0=i0
this.r=r
this.YC=YC
this.Pz=Pz
this.Of=Of
this.Fc=Fc}Bs.builtin$cls="Bs"
if(!"name" in Bs)Bs.name="Bs"
$desc=$collectedClasses.Bs
if($desc instanceof Array)$desc=$desc[1]
Bs.prototype=$desc
function ZXt(ES){this.ES=ES}ZXt.builtin$cls="ZXt"
if(!"name" in ZXt)ZXt.name="ZXt"
$desc=$collectedClasses.ZXt
if($desc instanceof Array)$desc=$desc[1]
ZXt.prototype=$desc
function LHu(x){this.x=x}LHu.builtin$cls="LHu"
if(!"name" in LHu)LHu.name="LHu"
$desc=$collectedClasses.LHu
if($desc instanceof Array)$desc=$desc[1]
LHu.prototype=$desc
function mOu(y){this.y=y}mOu.builtin$cls="mOu"
if(!"name" in mOu)mOu.name="mOu"
$desc=$collectedClasses.mOu
if($desc instanceof Array)$desc=$desc[1]
mOu.prototype=$desc
function FoV(z){this.z=z}FoV.builtin$cls="FoV"
...
if($desc instanceof Array)$desc=$desc[1]
Hf.prototype=$desc
function ICy(Sv){this.Sv=Sv}ICy.builtin$cls="ICy"
if(!"name" in ICy)ICy.name="ICy"
$desc=$collectedClasses.ICy
if($desc instanceof Array)$desc=$desc[1]
ICy.prototype=$desc
function eeE(pt){this.pt=pt}eeE.builtin$cls="eeE"
if(!"name" in eeE)eeE.name="eeE"
$desc=$collectedClasses.eeE
if($desc instanceof Array)$desc=$desc[1]
eeE.prototype=$desc
function pse(b,U9,T4){this.b=b
this.U9=U9
this.T4=T4}pse.builtin$cls="pse"
if(!"name" in pse)pse.name="pse"
$desc=$collectedClasses.pse
if($desc instanceof Array)$desc=$desc[1]
pse.prototype=$desc
function cMa(yL){this.yL=yL}cMa.builtin$cls="cMa"
if(!"name" in cMa)cMa.name="cMa"
$desc=$collectedClasses.cMa
if($desc instanceof Array)$desc=$desc[1]
cMa.prototype=$desc
function fM(RB,Y7,Ax,dL,Ay,Jf,YK,Jd,Co,lD,rr){this.RB=RB
this.Y7=Y7
this.Ax=Ax
this.dL=dL
this.Ay=Ay
...
if($desc instanceof Array)$desc=$desc[1]
Pd.prototype=$desc
function ea(d,e){this.d=d
this.e=e}ea.builtin$cls="ea"
if(!"name" in ea)ea.name="ea"
$desc=$collectedClasses.ea
if($desc instanceof Array)$desc=$desc[1]
ea.prototype=$desc
function yn(f,UI){this.f=f
...
if($desc instanceof Array)$desc=$desc[1]
oa.prototype=$desc
function da5(a,Gq){this.a=a
this.Gq=Gq}da5.builtin$cls="da5"
if(!"name" in da5)da5.name="da5"
$desc=$collectedClasses.da5
if($desc instanceof Array)$desc=$desc[1]
da5.prototype=$desc
function EA0(Rm){this.Rm=Rm}EA0.builtin$cls="EA0"
if(!"name" in EA0)EA0.name="EA0"
$desc=$collectedClasses.EA0
if($desc instanceof Array)$desc=$desc[1]
EA0.prototype=$desc
function PdI(a,w3,HZ){this.a=a
this.w3=w3
this.HZ=HZ}PdI.builtin$cls="PdI"
if(!"name" in PdI)PdI.name="PdI"
$desc=$collectedClasses.PdI
if($desc instanceof Array)$desc=$desc[1]
PdI.prototype=$desc
function Ca6(mG){this.mG=mG}Ca6.builtin$cls="Ca6"
if(!"name" in Ca6)Ca6.name="Ca6"
$desc=$collectedClasses.Ca6
if($desc instanceof Array)$desc=$desc[1]
Ca6.prototype=$desc
function eaA(xC){this.xC=xC}eaA.builtin$cls="eaA"
if(!"name" in eaA)eaA.name="eaA"
$desc=$collectedClasses.eaA
if($desc instanceof Array)$desc=$desc[1]
eaA.prototype=$desc
function wJm(cj){this.cj=cj}wJm.builtin$cls="wJm"
if(!"name" in wJm)wJm.name="wJm"
$desc=$collectedClasses.wJm
if($desc instanceof Array)$desc=$desc[1]
wJm.prototype=$desc
function zOk(jk){this.jk=jk}zOk.builtin$cls="zOk"
if(!"name" in zOk)zOk.name="zOk"
$desc=$collectedClasses.zOk
if($desc instanceof Array)$desc=$desc[1]
zOk.prototype=$desc
function yna(a,i0,r){this.a=a
this.i0=i0
this.r=r}yna.builtin$cls="yna"
if(!"name" in yna)yna.name="yna"
$desc=$collectedClasses.yna
if($desc instanceof Array)$desc=$desc[1]
yna.prototype=$desc
function Wba(a,YC,Pz){this.a=a
this.YC=YC
this.Pz=Pz}Wba.builtin$cls="Wba"
...
if($desc instanceof Array)$desc=$desc[1]
oaa.prototype=$desc
function d0(Fc){this.Fc=Fc}d0.builtin$cls="d0"
...
if($desc instanceof Array)$desc=$desc[1]
xU.prototype=$desc
function p4(mu,wx,O8,iv,Jy,Kk,YE,kj,dL,uc,Mq,Eu,cT,r6,Hk,C6,Hp,Rb,cb,Zd,lG,rH,e3,N4){this.mu=mu
this.wx=wx
this.O8=O8
this.iv=iv
this.Jy=Jy
...
if($desc instanceof Array)$desc=$desc[1]
na.prototype=$desc
function vXA(i0){this.i0=i0}vXA.builtin$cls="vXA"
...
this.b=b}hx.builtin$cls="hx"
if(!"name" in hx)hx.name="hx"
$desc=$collectedClasses.hx
if($desc instanceof Array)$desc=$desc[1]
hx.prototype=$desc
function Rk(Y7,Ax,FF,jb,eH,P,QG,lo,Y8,SO){this.Y7=Y7
this.Ax=Ax
this.FF=FF
this.jb=jb
this.eH=eH
...
if($desc instanceof Array)$desc=$desc[1]
Rk.prototype=$desc
Rk.prototype.gP=function(receiver){return this.P}
...
if($desc instanceof Array)$desc=$desc[1]
z8.prototype=$desc
function aC(WB,FX,Gc,VG,uf,ky,eE,Sr){this.WB=WB
this.FX=FX
this.Gc=Gc
this.VG=VG
this.uf=uf
...
if($desc instanceof Array)$desc=$desc[1]
zw.prototype=$desc
function kc(tH,rZ){this.tH=tH
this.rZ=rZ}kc.builtin$cls="kc"
if(!"name" in kc)kc.name="kc"
$desc=$collectedClasses.kc
if($desc instanceof Array)$desc=$desc[1]
kc.prototype=$desc
kc.prototype.gtH=function(receiver){return this.tH}
...
if($desc instanceof Array)$desc=$desc[1]
xj.prototype=$desc
function wD(LU,A5,tH,rZ){this.LU=LU
this.A5=A5
this.tH=tH
...
function I3(mk,NG,ic,Rn,Jf,Y7){this.mk=mk
this.NG=NG
this.ic=ic
this.Rn=Rn
this.Jf=Jf
this.Y7=Y7}I3.builtin$cls="I3"
if(!"name" in I3)I3.name="I3"
$desc=$collectedClasses.I3
if($desc instanceof Array)$desc=$desc[1]
I3.prototype=$desc
I3.prototype.gRn=function(receiver){return this.Rn}
...
if($desc instanceof Array)$desc=$desc[1]
jfk.prototype=$desc
function R0(bl,CD,nj){this.bl=bl
this.CD=CD
this.nj=nj}R0.builtin$cls="R0"
...
if($desc instanceof Array)$desc=$desc[1]
fj.prototype=$desc
function jD(J9,zx,WN,K9,cD,z7,hA){this.J9=J9
this.zx=zx
this.WN=WN
this.K9=K9
this.cD=cD
this.z7=z7
this.hA=hA}jD.builtin$cls="jD"
if(!"name" in jD)jD.name="jD"
$desc=$collectedClasses.jD
if($desc instanceof Array)$desc=$desc[1]
jD.prototype=$desc
function yT(vH,ku,hm,WN,K9,cD,z7,hA){this.vH=vH
this.ku=ku
this.hm=hm
this.WN=WN
this.K9=K9
...
function nB(BR,Et,VR,Ml){this.BR=BR
this.Et=Et
this.VR=VR
...
if($desc instanceof Array)$desc=$desc[1]
Xe.prototype=$desc
function Aj(Rn,P,Fn,cd,Tm,Q8){this.Rn=Rn
this.P=P
this.Fn=Fn
this.cd=cd
this.Tm=Tm
this.Q8=Q8}Aj.builtin$cls="Aj"
if(!"name" in Aj)Aj.name="Aj"
$desc=$collectedClasses.Aj
if($desc instanceof Array)$desc=$desc[1]
Aj.prototype=$desc
Aj.prototype.gRn=function(receiver){return this.Rn}
Aj.prototype.gP=function(receiver){return this.P}
Aj.prototype.gFn=function(){return this.Fn}
Aj.prototype.sFn=function(v){return this.Fn=v}
Aj.prototype.gcd=function(){return this.cd}
Aj.prototype.scd=function(v){return this.cd=v}
Aj.prototype.gTm=function(){return this.Tm}
Aj.prototype.gQ8=function(){return this.Q8}
...
if($desc instanceof Array)$desc=$desc[1]
mJ.prototype=$desc
function vs(YM,t9,O1,nV,bH,kO,bv,F1){this.YM=YM
this.t9=t9
this.O1=O1
this.nV=nV
this.bH=bH
...
if($desc instanceof Array)$desc=$desc[1]
W0.prototype=$desc
function zJ(n8,tL,hN){this.n8=n8
this.tL=tL
this.hN=hN}zJ.builtin$cls="zJ"
...
zJ.prototype.ghN=function(){return this.hN}
function Xu(n8,tL,hN){this.n8=n8
this.tL=tL
this.hN=hN}Xu.builtin$cls="Xu"
if(!"name" in Xu)Xu.name="Xu"
$desc=$collectedClasses.Xu
if($desc instanceof Array)$desc=$desc[1]
Xu.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
bJ.prototype=$desc
function JS(uF,Kx,mP,ae,wI){this.uF=uF
this.Kx=Kx
this.mP=mP
this.ae=ae
...
if($desc instanceof Array)$desc=$desc[1]
Tv.prototype=$desc
function I4(QV){this.QV=QV}I4.builtin$cls="I4"
if(!"name" in I4)I4.name="I4"
$desc=$collectedClasses.I4
if($desc instanceof Array)$desc=$desc[1]
I4.prototype=$desc
function C4(Ks){this.Ks=Ks}C4.builtin$cls="C4"
if(!"name" in C4)C4.name="C4"
$desc=$collectedClasses.C4
if($desc instanceof Array)$desc=$desc[1]
C4.prototype=$desc
C4.prototype.gKs=function(){return this.Ks}
...
function aV(ab,WD,fE,pj,Ks){this.ab=ab
this.WD=WD
this.fE=fE
this.pj=pj
...
if($desc instanceof Array)$desc=$desc[1]
U4.prototype=$desc
function qt(EJ,vK,XY,xo,Ng,L8,uZ,Hf,f6,nh,wS,Rt,yX,FS,bV,XD,CB,Hm,mC,BM,aP,u3,zU,Bv,Rh){this.EJ=EJ
this.vK=vK
this.XY=XY
this.xo=xo
this.Ng=Ng
...
qt.prototype.gf6=function(){return this.f6}
...
if($desc instanceof Array)$desc=$desc[1]
GS.prototype=$desc
function B3(Bd,EI,N1){this.Bd=Bd
this.EI=EI
...
if($desc instanceof Array)$desc=$desc[1]
hu.prototype=$desc
